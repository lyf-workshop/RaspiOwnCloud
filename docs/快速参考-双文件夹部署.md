...
| 文件夹 | 路径 | 用途 | 权限 |
|--------|------|------|------|
| **更新文件夹** | `~/Desktop/Github/RaspiOwnCloud/` | Git操作、代码更新 | pi用户 |
| **生产文件夹** | `/opt/raspberrycloud/` | 服务运行 | www-data |
...
| 脚本 | 用途 | 何时使用 |
|------|------|----------|
| `initial_deploy.sh` | 初始部署 | 首次部署 |
| `quick_update.sh` | 快速更新 | 日常更新（推荐） |
| `update_from_github.sh` | 完整更新 | 重大更新、需要备份时 |
...
完整说明请查看：[双文件夹部署架构说明](双文件夹部署架构说明.md)
